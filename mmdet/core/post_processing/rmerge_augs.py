...
def merge_tiles_aug_rbboxes(aug_bboxes,
    ...
    if isinstance(merge_cfg.nms['iou_threshold'], dict):
        assert classes is not None
        iou_thr_dict = merge_cfg.nms['iou_threshold']
        merge_cfg.nms['iou_threshold'] = [*map(lambda cls: iou_thr_dict.get(cls, 0.05), classes)]
