...
if __name__ == '__main__':
    trainsplit = DOTAImageSplitTool('F:\\BaiduNetdiskDownload\\Dota\\train',
                                    'F:\\BaiduNetdiskDownload\\Dota\\trainsplit',
                                    tile_overlap=(150, 150),
                                    tile_shape=(600, 600))
    trainsplit.split()
    valsplit = DOTAImageSplitTool('F:\\BaiduNetdiskDownload\\Dota\\val',
                                  'F:\\BaiduNetdiskDownload\\Dota\\valsplit',
                                  tile_overlap=(150, 150),
                                  tile_shape=(600, 600))
    valsplit.split()
    # testsplit = DOTAImageSplitTool('F:\\BaiduNetdiskDownload\\Dota\\test',
    #                               'F:\\BaiduNetdiskDownload\\Dota\\testsplit',
    #                               tile_overlap=(150, 150),
    #                               tile_shape=(600, 600))
    # testsplit.split()
